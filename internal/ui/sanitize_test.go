...
func TestStatusStyleCoversTheNewKinds(t *testing.T) {
	...
	warn := []string{"PENDING", "RECONCILING", "DETACHED", "STALE_KEY", "DRAINING", "CANCELLING",
		...
		"NO_CLEANUP", "CLEANUP_DRY_RUN", "NO_REPLICA", "NO_AUTH", "NO_DROP_PROTECTION",
		"DEVELOPMENT", "NO_DELETE_PROTECTION", "NO_PITR", "NODES_DOWN",
		"DEVELOPER_EDITION", "IDLE_SLOTS_RESERVED"}
